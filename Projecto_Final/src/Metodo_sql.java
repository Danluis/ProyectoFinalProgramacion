...
public class Metodo_sql {
	...
	public int guardar(String nombre_de_usuario, String nombre, String apellido, String telefono, String correo, String Contraseña, String C_Contraseña) {
		int resultado = 0;
		...
		try {
			...
			sentencia_preparada.setString(7, C_Contraseña);
	...
	public static String buscarUsuarioRegistrado(String usuario, String contraseña) {
		...
		try {
			...
			String sentencia_buscar_usuario =("SELECT User_Name,Nombre,Apellido,Telefono,Email,Password,C_Password FROM usuarios WHERE User_Name = '"+usuario+"' && Password = '"+contraseña+"'");
