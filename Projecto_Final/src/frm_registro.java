...
public class frm_registro extends JFrame {
	...
	private JPasswordField txtC_Contraseña;
	...
	public frm_registro() {
		...
		txtContraseña.setBounds(133, 216, 129, 20);
		contentPane.add(txtContraseña);
		
		txtC_Contraseña = new JPasswordField();
		txtC_Contraseña.setBounds(214, 241, 129, 20);
		contentPane.add(txtC_Contraseña);
		...
		btnGuardar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (txtC_Contraseña.equals(""))
				{
					JOptionPane.showMessageDialog(null, "El campo Confirmar_Contraseña esta vacio");
				} else {
					//aqui verificamos que las contraseñas no sean iguales
					if (txtContraseña.getText().equals(txtC_Contraseña.getText()))
					{
						
					
			int i =	metodos.guardar(txtUsuario.getText(), txtNombre.getText(), txtApellido.getText(), txtTelefono.getText(), txtCorreo.getText(), txtContraseña.getText(), txtC_Contraseña.getText());
